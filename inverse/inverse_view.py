...
class InverseView():
    def __init__(self):
        ...
        self.label_res = Gtk.Label(label = 'A⁻¹  =', halign = Gtk.Align.START)
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    def register_controller(self, controller):
        ...
        self.caculate_button.connect("clicked", controller.on_resolve_inverse_button_clicked)
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    def close(self, arg1 = None):
        self.controller.set_sensitive_button_launcher('inverse', True)
        self.win.destroy()
